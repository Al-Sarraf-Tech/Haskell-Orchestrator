...
tests :: TestTree
tests = testGroup "RenderSarif"
  [ testGroup "renderSarifJSON"
      ...
      , testCase "output contains finding message" $ do
          let out = renderSarifJSON "orchestrator" "1.0.0" [warnFinding]
          assertBool "Should contain finding message"
